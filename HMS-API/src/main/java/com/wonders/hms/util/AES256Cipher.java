...
public class AES256Cipher {
    ...
    static String secretKey; //32bit
    static String IV; //16bit

    public static AES256Cipher getInstance(String secretKey){
        if(INSTANCE==null){
            synchronized(AES256Cipher.class){
                if(INSTANCE==null)
                    INSTANCE=new AES256Cipher(secretKey);
            }
        }
        return INSTANCE;
    }

    private AES256Cipher(String secretKey){
